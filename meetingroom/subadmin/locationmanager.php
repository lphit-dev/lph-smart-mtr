...
<head>
    ...
    <link href="locationmanager.css" rel="stylesheet">
        ...
        <div class="container" id="app">
            <div class="row">
                <div class="container-fluid col-sm-6">
                    <h3 class="h3">ข้อมูลสถานที่ตั้งห้องประชุม</h3>
                </div>
                    ...
                    <div class="table-line">
                        <table class="table-bordered" style="width:100%;">
                            <tbody>
                                <tr class="table-mean">
                                    <th>ลำดับ</th>
                                    <th>ชื่อสถานที่ตั้งห้องประชุม</th>
                                    <th>จัดการ</th>
                                </tr>
            ...
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                ...
                                <div class="modal-body">
                                    <?php include_once "locationinsert.php";  ?>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                ...
                                <div class="modal-body">
                                    <?php include_once "locationedit.php";  ?>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            var app = new Vue({
                ...
                data: {
                    ...
                    list: [{
                        ...
                        id: 2,
                        LocationName: 'ชั้น 8 อาคารผู้ป่วยนอก',
                    }, ],
                }
            })
