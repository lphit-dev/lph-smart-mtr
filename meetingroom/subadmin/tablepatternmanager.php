...
<head>
    ...
    <link href="tablepatternmanager.css" rel="stylesheet">
        ...
        <div class="container" id="app">
            <div class="row">
                <div class="container-fluid col-sm-6">
                    <h3 class="h3">ข้อมูลรูปแบบการจัดโต๊ะ</h3>
                </div>
            ...
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                ...
                                <div class="modal-body">
                                    <?php include_once "tablepatterninsert.php";  ?>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                ...
                                <div class="modal-body">
                                    <?php include_once "tablepatternedit.php";  ?>
                                </div>
                            </div>
                        </div>
                    </div>
